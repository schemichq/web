...
The `$`-prefixed [field methods](/docs/reference/field-methods) and Zod's string formats add clauses to the `DEFINE FIELD`, in this order: `TYPE`, `DEFAULT`, `ASSERT`, `READONLY`, `PERMISSIONS`.
